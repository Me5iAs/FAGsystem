...
export class HomeComponent implements OnInit {
  public Opciones= [
    {Title:"Usuarios" , Subtitle: "Gestión de Usuarios", Image: 'banner_Mapa.png', Link: 'usuarios'},
    {Title:"Registrar Documentos" , Subtitle: "Gestión de documentos", Image: 'banner_delivery.png', Link: 'documentos'},
    {Title:"Observaciones" , Subtitle: "Gestión de Observaciones", Image: 'banner_bodegas.png', Link: 'observaciones'},
